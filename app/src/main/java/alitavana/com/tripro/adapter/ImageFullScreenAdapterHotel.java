...
public class ImageFullScreenAdapterHotel  extends PagerAdapter {

    private Activity _activity;
    private ArrayList<TripImage> _imagePaths;
    private LayoutInflater inflater;

    // constructor
    public ImageFullScreenAdapterHotel(Activity activity,
                                  ArrayList<TripImage> imagePaths) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        try {
            ...
            byte[] data = _imagePaths.get(position).getPhotoValue();
            Bitmap bmp = BitmapFactory.decodeByteArray(data, 0, data.length);
            adapter_slide_imageview.setImageBitmap(bmp);
        ...
        adapter_slide_image_information.setText(_imagePaths.get(position).getName());
        adapter_slide_image_authorname.setText("");
